...
# A100
gcloud beta container node-pools create pa100 --cluster=icecube --zone us-central1-c --node-taints=osglimit=gpu:PreferNoSchedule --node-labels=osgclass=gpu,gputype=a100 --machine-type a2-highgpu-1g --accelerator "type=nvidia-tesla-a100,count=1" --num-nodes=1 --spot
