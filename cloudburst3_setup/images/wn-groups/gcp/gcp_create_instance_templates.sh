...
# z1
gcloud compute --project=exa-demo instance-templates create it-exa3-us-central-1-t4-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3-us-central-1 \
    --accelerator=type=nvidia-tesla-t4,count=1

gcloud compute --project=exa-demo instance-templates create it-exa3-us-central-1-v100-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3-us-central-1 \
    --accelerator=type=nvidia-tesla-v100,count=1
...
# z2
gcloud compute --project=exa-demo instance-templates create it-exa3b-us-central-1-t4-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3b-us-central-1 \
    --accelerator=type=nvidia-tesla-t4,count=1

gcloud compute --project=exa-demo instance-templates create it-exa3b-us-central-1-v100-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3b-us-central-1 \
    --accelerator=type=nvidia-tesla-v100,count=1

# z3
gcloud compute --project=exa-demo instance-templates create it-exa3c-us-central-1-t4-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3c-us-central-1 \
    --accelerator=type=nvidia-tesla-t4,count=1

gcloud compute --project=exa-demo instance-templates create it-exa3c-us-central-1-v100-v1 $IMAGE "$SSHKEY" \
    --min-cpu-platform="Intel Broadwell" \
    --region=us-central1 --subnet=projects/exa-demo/regions/us-central1/subnetworks/exa3c-us-central-1 \
    --accelerator=type=nvidia-tesla-v100,count=1
