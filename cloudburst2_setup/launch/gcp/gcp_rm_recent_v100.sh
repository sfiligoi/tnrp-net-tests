...
idles=`condor_status -const '(CLOUD_Provider == "Google")&&(SlotId==1)&&(Activity=="Busy")&&((CurrentTime-LastHeardFrom)<301)&&((CurrentTime-EnteredCurrentActivity)<200)' -af GCP_VM_NAME `
